...
document.addEventListener("DOMContentLoaded", function(event) {
	  ...
	  var x = document.getElementById("health").value;
            ...
            <progress id="myProgress" value="30" max="100" data-label="30%" lab="Initiate">
</progress>

<progress id="myProgress" value="25" max="100" data-label="25%" lab="Plan" >
</progress>
<progress id="myProgress" value="55" max="100" data-label="55%" lab="Execute">
</progress>
<progress  id="pr1" value="20" max="100" data-label="10%" lab="Hypercare"></progress>
