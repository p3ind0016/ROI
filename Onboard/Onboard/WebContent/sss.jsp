...
.bs-wizard > .bs-wizard-step > .bs-wizard-dot {position: absolute; width: 30px; height: 30px; display: block; background: #fbe8aa; top: 45px; left: 50%; margin-top: -15px; margin-left: -15px; border-radius: 100%;} 
...
String query3 = "select * from projinfo where id = '7'";
Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/strutsdb", "root", "password123");
String query = "select * from app_prior  where prj_name='Project1'";
Statement st = conn.createStatement();
ResultSet rs = st.executeQuery(query);

Statement st3 = conn.createStatement();
ResultSet rs3 = st3.executeQuery(query3);
String query1= "SELECT * from app_prior where prj_name='Project1'";
%>
...
<script>
                ...
                columns: {
                    identifier: [0, 'id'],
                    editable: [[5, 'Nickname', '{"1": "1", "2": "2", "3": "3", "4": "4"}']]
                }
            });
