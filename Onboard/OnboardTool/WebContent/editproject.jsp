...
HttpSession sess = request.getSession(false);
  String no = sess.getAttribute("projectattr").toString();
%>	
<%
...
String query = "select * from projinfo where projectname='"+no+"'";
...
<form class="form-signin" name="loginForm" method="get" action="Project">
<div class="container">
